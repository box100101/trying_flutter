...
- Phase 3 / Milestone 2: Cubit mental model
...
- Lesson 13 restarted on 2026-03-30 at the learner's request: understanding the Cubit mental model through the auth sign-in flow, from UI actions to Cubit methods, emitted states, and UI reactions in the Android-first chat app

## Evidence Required To Pass Current Gate
- The learner can explain Cubit flow and why Cubit does not need separate event classes
- The learner can map an auth, profile, search, or chat feature into `UI action -> Cubit method -> emitted state -> UI reaction`

## Homework Status
- Lesson 1 homework reviewed and passed on 2026-03-26. Lesson 2 homework reviewed and passed on 2026-03-26. Lesson 3 homework reviewed and passed on 2026-03-26. Lesson 4 homework reviewed and passed on 2026-03-26. Lesson 5 homework reviewed and passed on 2026-03-26. Lesson 6 homework reviewed and passed on 2026-03-26. Lesson 7 homework reviewed and passed on 2026-03-26. Lesson 8 homework reviewed and passed on 2026-03-26. Lesson 9 homework reviewed and passed on 2026-03-26. Lesson 10 homework reviewed and passed on 2026-03-29. Lesson 11 homework reviewed and passed on 2026-03-29. Lesson 12 homework reviewed and passed on 2026-03-30. Lesson 13 homework re-assigned on 2026-03-30: map the current `sign_in` flow into `UI action -> Cubit method -> emitted state -> UI reaction`, then explain the role of `submitSignIn()`, `SignInLoading`, `SignInSuccess`, and `SignInFailure`
...
- Use the learner's current `sign_in` screen to introduce the Cubit mental model without implementing full Firebase logic yet
- Review whether the learner can map user actions into Cubit methods and emitted states for the auth flow
